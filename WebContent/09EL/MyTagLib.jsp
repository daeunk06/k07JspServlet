...
<body>
	...
	<ul>
		<li>1 : ${my:getGender("123456-1000000") }</li>
		<li>2 : ${my:getGender("123456-2000000") }</li>
		<li>9 : ${my:getGender("123456-9000000") }</li>
	</ul>
