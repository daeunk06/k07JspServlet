...
<body>
	...
	<!-- 
	기본값이나 true일때 html이 해석디지 않고 태그까지 그도 출력 
	...
	<!-- 
	false일때는html이 해석디어져서 화면에 출력 st의 innerHTMl()과 동일함
	 -->
	...
	<!-- 
	out태그에 value속성의 값이 null일때는 default속성에 지정된 값 출력
	단, 값이 빈 문자열""인 경우 있는것으로 간주되어  default속성값 출력안됨.
	 -->
	<h3>default속성</h3>
	...
	<!-- 
	-파라미터로 전달되는 nowPage가 없는 경우 1, 있는경우 해당 파라미터값을 가져와서 페이지에
	적용한다/.
	 -->
	<h3>페이지 링크에 응용하기</h3>
	<c:url value="/08Board1/BoardList.jsp?nowPage="/><c:out value="${param.nowPage }" default="1"></c:out>
	<hr />
