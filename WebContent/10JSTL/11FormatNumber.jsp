...
<body>
	...
	<!-- value속성값으로 전달되는 값을 %단위로 변환해 출력함 -->
	<h3>type="percent"</h3>
	money : <fmt:formatNumber value="0.05" type="percent"/>
	...
	/*
		NumberFormat클래스는 싱글턴 패턴으로 제작된 클래스로 new연산자를 통해 객체를
		생성 할 수 없는 대표적인 클래스 getinstance를 통해 이미 생성된  static
		형태의 객체를 반환받아 사용하게 된다.
	*/
